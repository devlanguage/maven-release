 ...
 * </pre>
 */
public class RedisTest extends JedisTestBase {
    protected static redis.clients.jedis.HostAndPort hnp = HostAndPortUtil.getRedisServers().get(0);
    ...
    public void setUp() throws Exception {
        jedis = new redis.clients.jedis.Jedis(hnp.getHost(), hnp.getPort(), 500);
        jedis.connect();
        jedis.auth("foobared");
