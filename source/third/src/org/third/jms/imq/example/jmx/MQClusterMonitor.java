package org.third.jms.imq.example.jmx;
...
public class MQClusterMonitor implements ActionListener, Runnable {
    ...
    public MQClusterMonitor(JFrame f, String address, String adminUser, String adminPasswd,
            long seconds) {
    ...
    public void load() {
        ...
        try {
            CompositeData cd[] = (CompositeData[]) mbsc.invoke(clsMon,
                    ClusterOperations.GET_BROKER_INFO, null, null);
            ...
            public TableCellRenderer getCellRenderer(int row, int col) {
                ...
                switch (state) {
                    ...
                    case BrokerState.SHUTDOWN_STARTED:
                        ...
                        /*
                         * default case handles: BrokerState.OPERATING: BrokerState.QUIESCE_STARTED:
    ...
    private String getDefaultAddress() {
        ...
        /*
         * AdminConnectionFactory acf = new AdminConnectionFactory(); String addr;
         * 
         * try { addr = acf.getProperty(AdminConnectionConfiguration.imqAddress); } catch(Exception
         * e) { addr = null; }
         * 
         * return (addr);
         */
...
class ClusterTableModel extends AbstractTableModel {
    ...
    private String[] columnNames = { "Broker ID", "Broker Address", "Broker State",
            "# Msgs in Store", "Takeover Broker ID", "Time since last status timestamp" };
    ...
    public Object getValueAt(int row, int column) {
        ...
        switch (column) {
            ...
            case 2:
                return (BrokerState.toString(((Integer) info.get(BrokerClusterInfo.STATE))
                        .intValue()));
