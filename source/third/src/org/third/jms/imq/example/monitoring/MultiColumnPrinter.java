package org.third.jms.imq.example.monitoring;
...
/**
 * Utility class for printing aligned collumns of text. How/where the text is printed is determined
 * by the abstract methods doPrint(String) and doPrintln(String). The typical case is to create a
 * subclass and make these methods print the string to standard out or error.
 * <P>
 * This class allows you to specify:
 * <UL>
 * <LI>The number of collumns in the output. This will determine the dimension of the string arrays
 * passed to add(String[]) or addTitle(String[]).
 ...
 * <PRE>
 * 
 * MyPrinter mp = new MyPrinter(3, 2, "-"); String oneRow[] = new String [ 3 ]; oneRow[0] = "User
 * Name"; oneRow[1] = "Email Address"; oneRow[2] = "Phone Number"; mp.addTitle(oneRow);
 * 
 * oneRow[0] = "Bob"; oneRow[1] = "bob@foo.com"; oneRow[2] = "123-4567"; mp.add(oneRow);
 * 
 * oneRow[0] = "John"; oneRow[1] = "john@foo.com"; oneRow[2] = "456-7890"; mp.add(oneRow);
 * mp.print();
 * 
 * </PRE>
 * 
 ...
 * -------------------------------------- Bob bob@foo.com 123-4567 John john@foo.com 456-7890
 * 
 * </PRE>
 * 
 * <P>
 * This class also supports multi-row titles and having title strings spanning multiple collumns.
 * Example usage:
 * 
 * <PRE>
 * 
 * TestPrinter tp = new TestPrinter(4, 2, "-"); String oneRow[] = new String [ 4 ]; int[] span = new
 * int[ 4 ];
 * 
 * span[0] = 2; // spans 2 collumns span[1] = 0; // spans 0 collumns span[2] = 2; // spans 2
 * collumns span[3] = 0; // spans 0 collumns
 * 
 * tp.setTitleAlign(CENTER); oneRow[0] = "Name"; oneRow[1] = ""; oneRow[2] = "Contact"; oneRow[3] =
 * ""; tp.addTitle(oneRow, span);
 * 
 * oneRow[0] = "First"; oneRow[1] = "Last"; oneRow[2] = "Email"; oneRow[3] = "Phone";
 * tp.addTitle(oneRow);
 * 
 * oneRow[0] = "Bob"; oneRow[1] = "Jones"; oneRow[2] = "bob@foo.com"; oneRow[3] = "123-4567";
 * tp.add(oneRow);
 * 
 * oneRow[0] = "John"; oneRow[1] = "Doe"; oneRow[2] = "john@foo.com"; oneRow[3] = "456-7890";
 * tp.add(oneRow);
 * 
 * tp.println();
 * 
 ...
 * ------------------------------------ Bob Jones bob@foo.com 123-4567 John Doe john@foo.com
 * 456-7890
 * 
 * </PRE>
 * 
...
public abstract class MultiColumnPrinter {
    ...
    /*
     * Sets the default sorting behavior. When set to true, the table entries are sorted unless
    ...
    /**
     * Adds to the row of strings to be used as the title for the table. Also allows for certain
     * title strings to span multiple collumns The span parameter is an array of integers which
     * indicate how many collumns the corresponding title string will occupy. For a row that is 4
     * collumns wide, it is possible to have some title strings in a row to 'span' multiple
     * collumns:
     * 
     * <P>
     * 
     ...
     * </PRE>
     * 
     * In the example above, the title row has a string 'Name' that spans 2 collumns. The string
     * 'Contact' also spans 2 collumns. The above is done by passing in to addTitle() an array that
     * contains:
     * 
     * <PRE>
     * 
     * span[0] = 2; // spans 2 collumns span[1] = 0; // spans 0 collumns, ignore span[2] = 2; //
     * spans 2 collumns span[3] = 0; // spans 0 collumns, ignore
     * 
     * </PRE>
     * 
     * <P>
     ...
     * <PRE>
     * 
     * int[] span = new int [ row.length ]; for (int i = 0; i < row.length; i++) { span[i] = 1; }
     * addTitle(row, span);
     * 
     * </PRE>
     * 
     ...
     *            Array of strings to print in one row of title.
     * @param span
     *            Array of integers that reflect the number of collumns the corresponding title
     *            string will occupy.
     */
    ...
    /*
     * Creates the key for the current row based on the criteria specified by setKeyCriteria(). If
     * key cannot be created by the criteria, it simply returns null.
     * 
    ...
    /*
     * Sets the criteria for the key. new int[] {0, 1} means use the first and the second elements
     * of the array.
     */
    ...
    /**
     * Method that does the actual printing. Override this method to print to your destination of
     * choice (stdout, stream, etc).
     * 
     * @param str
     *            String to print.
     */
