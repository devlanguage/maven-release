 ...
 */
public class CxfRequest extends AbstractPhaseInterceptor {

    private static final Logger LOG = Logger.getLogger(CxfRequest.class.getName());

    private static final String TLB_CHECK_TAG = "x-tlb-metadata";
