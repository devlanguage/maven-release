 ...
 *  Last modifed on 2:11:39 PM Aug 19, 2014
 *
 *****************************************************************************
 */
...
public class TeacherServiceImpl extends TeacherService {
     ...
     * (non-Javadoc)
     * 
     * @see org.third.cxf.rest.TeacherService#getTeacher(javax.servlet.http.HttpServletRequest,
    ...
    public Response getRequest(HttpServletRequest request, HttpServletResponse response) {
        ...
        output.append("<data>");
        try {
            String ins = StringUtil.streamToStringBuffer(request.getInputStream());
     ...
     * (non-Javadoc)
     * 
     * @see org.third.cxf.rest.TeacherService#getTeacherByMatrix(long, java.lang.String, long)
     */
    @Override
