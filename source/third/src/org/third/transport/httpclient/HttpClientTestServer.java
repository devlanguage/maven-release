 ...
 *  Last modifed on 10:12:10 AM Mar 6, 2014
 *
 *****************************************************************************
 */
        ...
        try {
            ...
            httpServer.createContext("/test", new HttpHandler() {
                ...
                public void handle(HttpExchange t) throws IOException {
                    ...
                    System.out.println(org.basic.common.util.StringUtil.streamToStringBuffer(reqBody));
            ...
            hss.createContext("/test", new org.basic.jdk.jdk7.e5_networking.httpserver.HttpRequestHandler());// 用MyHandler类内处理到/的请求
            hss.start();
