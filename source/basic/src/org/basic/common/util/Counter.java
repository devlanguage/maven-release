...
public class Counter {
    ...
    public final void printPerformance(CommonLogger logger, String target) {
        ...
        if (value == 0) {
            ...
            if (value % freqeuncy == 0) {
                ...
                if (interval != 0) {
                    logger.log(CommonLogger.SEVERE, target, "Process Speed: " + (value * 1000.0 / interval)
                            + " times per seconds");
                } else {
                    logger.log(CommonLogger.SEVERE, target,
