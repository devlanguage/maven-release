package org.basic.net.c20_jmx.jdmk.current.Security.jmxmp.sasl_provider.server;
...
public class Server {
    ...
    public static void main(String[] args) {
        try {
            ...
            // Add SASL/SAMPLE mechanism server provider
            //
            Security.addProvider(new Provider());

            // The profile supported by this server is SASL/SAMPLE
            //
