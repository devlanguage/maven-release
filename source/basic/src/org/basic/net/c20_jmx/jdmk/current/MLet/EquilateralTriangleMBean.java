...
/*
 * @(#)file      EquilateralTriangleMBean.java
...
/**
 * This is the management interface explicitly defined for
 * the "EquilateralTriangle" standard MBean.
 *
 * The "EquilateralTriangle" standard MBean implements this
 * interface in order to be manageable through a JMX agent.
 *
 * The "EquilateralTriangleMBean" interface shows how to expose for management:
 * - a read/write attribute (named "SideLength") through its getter and setter
 *   methods.
 */

public interface EquilateralTriangleMBean {
