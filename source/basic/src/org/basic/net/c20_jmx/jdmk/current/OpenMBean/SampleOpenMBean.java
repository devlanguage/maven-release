...
public class SampleOpenMBean implements DynamicMBean {
    ...
    //
    private static String[] itemNames = { "model",
                                          "color",
                                          "size",
                                          "price" };
    ...
    private static String[] legalColors = { "black",
                                            "white",
                                            "red",
                                            "green",
                                            "blue" };
    ...
    static {
        ...
        try {
            ...
            //
            modelParamInfo = new OpenMBeanParameterInfoSupport(
                      "model",
            ...
            colorParamInfo = new OpenMBeanParameterInfoSupport(
                      "color", 
            ...
            sizeParamInfo = new OpenMBeanParameterInfoSupport(
                     "size",
            ...
            priceParamInfo = new OpenMBeanParameterInfoSupport(
                      "price", 
                      "Valid product price (ranging from $" +
     ...
     * if it does not already exist and returns Boolean.TRUE if successful,
     * Boolean.FALSE otherwise.
     */
    public Boolean addTShirt(CompositeData tShirt) {
        try {
            // Throws KeyAlreadyExistsException if index for tShirt already
            // exists in tShirts
            //
            tShirts.put(tShirt);
            nbChanges++;
    ...
    /**
     * Builds and returns a new CompositeData TShirt instance from the
     * specified parameters. If parameter values are not legal according
     * to the OpenMBeanParameterInfo instances for this method, it throws
     * an OpenDataException. If model, color or size are null, it uses the
     * default value provided in the OpenMBeanParameterInfo instances for
     * this method.
     */
    public CompositeData buildTShirt(String model, String color,
        ...
        // Check parameter values are legal, assign default if necessary,
        // or throws OpenDataException
        //
        ...
        CompositeData result =
            new CompositeDataSupport(tShirtType, itemNames, itemValues);
    ...
    public void removeTShirt(CompositeData tShirt) {
        ...
        // (alternately we could have tested with a containsValue
        // or containsKey call before removing)
    ...
    public Object invoke(String operationName,
        ...
        if (operationName.equals("addTShirt")) {
            ...
            if ((params.length != 1) ||
                ...
                throw new RuntimeOperationsException(
                      new IllegalArgumentException(
                                 "Cannot invoke addTShirt: expecting " +
                                 "params[0] instanceof CompositeData"),
            ...
            try {
                ...
                throw new MBeanException(e, "Invoking addTShirt: " +
                                         e.getClass().getName() +
                                         "caught [" + e.getMessage() + "]");
            }
        }
        ...
        //
            ...
            if ((params.length != 1) ||
                ...
                throw new RuntimeOperationsException(
                      new IllegalArgumentException(
                                 "Cannot invoke removeTShirt: expecting " +
                                 "params[0] instanceof CompositeData"),
                      "Wrong content for array Object[] params to invoke " +
                      "removeTShirt method");
            }
        ...
        // public CompositeData buildTShirt(SimpleData model, SimpleData color,
        //                                  SimpleData size, SimpleData price)
        //
            ...
            if ((params.length != 4) ||
                ...
                throw new RuntimeOperationsException(
                      new IllegalArgumentException(
                          "Cannot invoke buildTShirt: expecting params[i] " +
                          "instanceof SimpleData for i = 0 to 3"),
                      "Wrong content for array Object[] params to invoke " +
                      "buildTShirt method");
            }
            // Invoke  buildTShirt
            //
            try {
                return buildTShirt((String)params[0], (String)params[1],
    ...
    private void buildMBeanInfo() throws OpenDataException {
        ...
        OpenMBeanAttributeInfoSupport[] attributes =
            new OpenMBeanAttributeInfoSupport[2];
        ...
        // Attribute TShirts (no default or legal values: not supported
        // for tabular types anyway)
        //
        attributes[0] =
            new OpenMBeanAttributeInfoSupport("TShirts",
        ...
        //
        attributes[1] =
            new OpenMBeanAttributeInfoSupport("NbChanges",
                                              "Number of times the TShirts " +
        ...
        constructors[0] = new OpenMBeanConstructorInfoSupport(
                              "SampleOpenMBean",
                              "Constructs a SampleOpenMBean instance " +
                              "containing an empty TShirts list.",
                              new OpenMBeanParameterInfoSupport[0]);

        // Operation addTShirt
        //
        OpenMBeanParameterInfo[] params_add =
        ...
        operations[0] = new OpenMBeanOperationInfoSupport(
            "addTShirt",
            "Adds the tShirt given in parameter to the list of available " +
            "tShirts if it does not already exist, and returns Boolean.TRUE " +
            "if succesful, Boolean.FALSE otherwise.",
            params_add,
            SimpleType.BOOLEAN,
        ...
        operations[1] = new OpenMBeanOperationInfoSupport(
            "removeTShirt",
            "Removes the tShirt given in parameter to the list of available " +
            "tShirts, if a tshirt with the same index existed in the list, " +
        ...
        //
        OpenMBeanParameterInfo[] params_build =
            new OpenMBeanParameterInfoSupport[4];
        ...
        operations[2] = new OpenMBeanOperationInfoSupport(
            "buildTShirt",
            "Builds and returns a CompositeData TShirt instance from the " +
            "specified parameters. If parameter values are not legal " +
            "according to the OpenMBeanParameterInfo instances for this " +
            "method, it throws an OpenDataException. If model, color or " +
            "size are null, it uses the default value provided in the " +
            "OpenMBeanParameterInfo instances for this method.",
            params_build,
            tShirtType,
