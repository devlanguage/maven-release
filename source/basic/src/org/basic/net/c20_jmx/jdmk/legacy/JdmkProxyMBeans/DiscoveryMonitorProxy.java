...
//
// Generated by proxygen version 5.1 when compiling com.sun.jdmk.discovery.DiscoveryMonitor (Tue Apr 13 19:28:21 MEST 2004).
//
...
/**
 * The implementation of the DiscoveryMonitorProxyMBean Proxy MBean interface.
 *
 * @see com.sun.jdmk.tools.ProxyGen 
 */
public class DiscoveryMonitorProxy implements DiscoveryMonitorProxyMBean, com.sun.jdmk.Proxy, com.sun.jdmk.NotificationBroadcasterProxy {
   ...
   */
  public DiscoveryMonitorProxy(ObjectInstance oi) {    
    objectInstance = oi ;
  }
   ...
   */
  public DiscoveryMonitorProxy(ObjectInstance oi, ProxyHandler server) {    
    objectInstance = oi ;
    this.server = server ;
  }
