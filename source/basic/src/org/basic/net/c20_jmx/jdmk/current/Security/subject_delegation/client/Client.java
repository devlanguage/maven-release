...
public class Client {
    ...
    public static void main(String[] args) {
        try {
            ...
            Subject delegationSubject = new Subject(true, Collections.singleton(new JMXPrincipal("delegate")), Collections.EMPTY_SET,
            ...
            // server connection
            //
            SimpleStandardMBean proxy = JMX.newMBeanProxy(mbsc, mbeanName, SimpleStandardMBean.class);
