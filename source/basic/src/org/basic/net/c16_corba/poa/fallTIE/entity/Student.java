...
public final class Student implements org.omg.CORBA.portable.IDLEntity
{
  ...
  public org.basic.net.c16_corba.poa.fallTIE.entity.Sex sex = null;

  public Student ()
  {
  } // ctor

  public Student (String _stuName, org.basic.net.c16_corba.poa.fallTIE.entity.IconSizes _iconSize, org.basic.net.c16_corba.poa.fallTIE.entity.Sex _sex)
  {
    stuName = _stuName;
    iconSize = _iconSize;
    sex = _sex;
