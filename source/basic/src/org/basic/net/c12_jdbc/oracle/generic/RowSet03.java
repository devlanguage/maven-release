...
public class RowSet03 {
    public static void main(String[] args) {
        ...
        try {
            ...
            CachedRowSet copyRowSet = crowset.createCopy();
            System.out.println("Displaying all the rows from the copy of " + "the rowset");
            System.out.println("Seat no  Travel Date  Name   Class");
            System.out.println("-------  ------ ----  ----   -----");
             ...
             * original copy also. Where as the local properties like cursor
             * position is not shared between the copies.
             */
            System.out.println("");
            System.out.println("Creating a shared copy of rowset");
            OracleCachedRowSet sharedRowSet = (OracleCachedRowSet) crowset.createShared();
            System.out.println("Displaying all the rows from the shared copy of the rowset");
            System.out.println("Seat no  Travel Date  Name   Class");
            System.out.println("-------  ------ ----  ----   -----");
    ...
    public static void printRow(RowSet rowset) throws SQLException {
        System.out.println(rowset.getInt(1) + "      " + rowset.getDate(2) + "   " + rowset.getString(3) + "  " + rowset.getString(4));
