...
FEB 26TH, 2013
Java is a safe programming language and prevents programmer from doing a lot of stupid mistakes, most of which based on memory management. But, there is a way to do such mistakesintentionally, using Unsafe class.
...
Conclusion
Although, Unsafe has a bunch of useful applications, never use 
