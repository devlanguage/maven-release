 ...
 * 
 */
public class HelloworldClassLoader2 extends ClassLoader {

    private String userDefinedClassBaseDir;

    public HelloworldClassLoader2(ClassLoader parent) {

        this(parent, JvmConstants.JVM_RESOURCES2);
    }

    public HelloworldClassLoader2(ClassLoader parent, String baseDir) {
