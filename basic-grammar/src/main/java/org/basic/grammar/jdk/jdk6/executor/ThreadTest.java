package org.basic.grammar.jdk.jdk6.executor;
...
import org.basic.grammar.jdk.jdk6.executor.callable.ConsumerThread_Callable;
import org.basic.grammar.jdk.jdk6.executor.callable.ProducerThread_Callable;
import org.basic.grammar.jdk.jdk6.executor.future.PrimeCallable;
import org.basic.grammar.jdk.jdk6.executor.runnable.ConsumerThread_Runnable;
import org.basic.grammar.jdk.jdk6.executor.runnable.ProducerThread_Runnable;
...
public class ThreadTest {
	...
	private final static void testExecutors() {
		...
		// scheduledExecutor.scheduleAtFixedRate(r, initialDelay, period,
		// TimeUnit.SECONDS);
