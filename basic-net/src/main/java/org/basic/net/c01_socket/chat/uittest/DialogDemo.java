package org.basic.net.c01_socket.chat.uittest;
...
public class DialogDemo extends JPanel {
    ...
    public DialogDemo(JFrame frame) {
        ...
        label = new JLabel("Click the \"Show it!\" button" + " to bring up the selected dialog.",
                JLabel.CENTER);
     ...
     */
    private JPanel create2ColPane(String description, JRadioButton[] radioButtons,
            JButton showButton) {
     ...
     * showMessageDialog, but you can specify the icon (using similar code) for any other kind of
     * dialog, as well.
     */
        ...
        showItButton.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                if (command == plainCommand) {
                    ...
                    JOptionPane.showMessageDialog(frame, "You shouldn't use a message dialog "
