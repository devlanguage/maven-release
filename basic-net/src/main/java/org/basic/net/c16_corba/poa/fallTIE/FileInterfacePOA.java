...
/**
* org/basic/corba/poa/fallTIE/FileInterfacePOA.java .
* �� IDL-to-Java ������������ֲ�����汾 "3.2" ���
* ���� FileServer.idl
...
public abstract class FileInterfacePOA extends org.omg.PortableServer.Servant
 implements org.basic.net.c16_corba.poa.fallTIE.FileInterfaceOperations, org.omg.CORBA.portable.InvokeHandler
{
                                ...
                                org.omg.CORBA.portable.ResponseHandler $rh)
  {
    ...
    switch (__method.intValue ())
    {
       case 0:  // org/basic/corba/poa/fallTIE/FileInterface/downloadFile
       {
         ...
         org.basic.net.c16_corba.poa.fallTIE.FileInterfacePackage.Data $result[] = null;
         $result = this.downloadFile (fileName);
         out = $rh.createReply();
         org.basic.net.c16_corba.poa.fallTIE.FileInterfacePackage.DataListHelper.write (out, $result);
         break;
       }
       ...
       case 1:  // org/basic/corba/poa/fallTIE/FileInterface/sayHi
       {
         ...
         org.basic.net.c16_corba.poa.fallTIE.entity.Student $result = null;
         $result = this.sayHi (user);
         out = $rh.createReply();
         org.basic.net.c16_corba.poa.fallTIE.entity.StudentHelper.write (out, $result);
         break;
       }
