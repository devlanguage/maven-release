...
/**
* org/basic/corba/poa/fall/FileInterfacePackage/Data.java .
* �� IDL-to-Java ������������ֲ�����汾 "3.2" ���
* ���� FileServer.idl
...
public final class Data implements org.omg.CORBA.portable.IDLEntity
{
  ...
  public org.basic.net.c16_corba.oldImplBase.fall.entity.Bounds viewExtent = null;
  public org.basic.net.c16_corba.oldImplBase.fall.entity.IconSizes iconSize = null;

  //enum IconSize { Micro, Small, Medium, Large };
  public org.basic.net.c16_corba.oldImplBase.fall.entity.IconFontSizes iconFontSize = null;
  ...
  public Data (int _viewId, double _overlap, String _name, boolean _filterLabels, boolean _systemView, boolean _overwrite, boolean _deleteThis, org.basic.net.c16_corba.oldImplBase.fall.entity.Bounds _viewExtent, org.basic.net.c16_corba.oldImplBase.fall.entity.IconSizes _iconSize, org.basic.net.c16_corba.oldImplBase.fall.entity.IconFontSizes _iconFontSize, String[] _geoEntities)
  {
    viewId = _viewId;
    overlap = _overlap;
    name = _name;
