...
public class ActiveMqServerPerformanceTest {
    ...
    public static void main(String[] args) {
        ...
        try {
            Session jmsSession1 = JmsUtil.getInstance().getSession(JmsServerType.ACTIVE_MQ, false, javax.jms.Session.AUTO_ACKNOWLEDGE);
            Session jmsSession2 = JmsUtil.getInstance().getSession(JmsServerType.ACTIVE_MQ, false, javax.jms.Session.AUTO_ACKNOWLEDGE);
