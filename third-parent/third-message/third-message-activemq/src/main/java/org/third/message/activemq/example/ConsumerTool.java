package org.third.message.activemq.example;
...
public class ConsumerTool implements MessageListener, ExceptionListener {
    ...
    private String user = ActiveMQConnection.DEFAULT_USER; // system
    private String password = ActiveMQConnection.DEFAULT_PASSWORD;// manager
    private String url = "tcp://vesna:61616";//ActiveMQConnection.DEFAULT_BROKER_URL;
    ...
    public void run() {
        try {
            ...
            org.apache.activemq.ActiveMQConnectionFactory connectionFactory = new ActiveMQConnectionFactory(user, password, url);
