...
/**
 * The SynchQueueExample class consists only of a main method, which fetches one or more messages
 * from a queue using synchronous message delivery. Run this program in conjunction with
 * SenderToQueue. Specify a queue name on the command line when you run the program.
 * <p>
...
public class SynchQueueExample {
    ...
    public static void main(String[] args) {
        ...
        if (args.length != 1) {
            ...
            queueName = "SynchQueueExample_Queue";
        } else {
        ...
        /*
         * Obtain connection factory. Create connection. Create session from connection; false means
         * session is not transacted. Obtain queue name.
         */
        try {
        ...
        /*
         * Create consumer, then start message delivery. Receive all text messages from queue until
         * a non-text message is received indicating end of message stream. Close connection and
         * exit.
         */
        try {
