...
public class Vendor extends Thread {
    ...
    public void run() {
        ...
        try {
            ...
            retailerOrderQueue = SampleUtilities.getQueue(TransactionOrderTest.A1_retailerOrderQueueName, transactionSession);
            
            vendorMonitorOrderQueue = SampleUtilities.getQueue(TransactionOrderTest.B1_monitorOrderQueueName, transactionSession);
            vendorStorageOrderQueue = SampleUtilities.getQueue(TransactionOrderTest.B2_storageOrderQueueName, transactionSession);
            vendorConfirmationQueue = SampleUtilities.getQueue(TransactionOrderTest.BN_vendorConfirmationQueueName, transactionSession);
        } catch (Exception e) {
