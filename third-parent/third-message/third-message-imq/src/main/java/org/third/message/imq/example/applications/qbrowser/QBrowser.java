package org.third.message.imq.example.applications.qbrowser;
...
public class QBrowser extends JPanel implements javax.jms.MessageListener {
    ...
    QBrowser() {
        ...
        try {
            ...
            System.err.println("Are you sure there is an imqbrokerd running on " + serverHost + ":" + serverPort + "?");
            usage();
        }
    ...
    private void connect() throws JMSException {
        ...
        if (connection == null) {
            setFooter("Connecting to " + serverHost + ":" + serverPort + "...");
            initJMS();
