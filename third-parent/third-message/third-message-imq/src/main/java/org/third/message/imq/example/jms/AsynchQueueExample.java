...
/**
 * The AsynchQueueExample class consists only of a main method, which fetches one or more messages
 * from a queue using asynchronous message delivery.
 * <p>
 * Compile TextListener.java before you run this program.
 * <p>
 * Run this program in conjunction with SenderToQueue. Specify a queue name on the command line when
 * you run the program.
 */
public class AsynchQueueExample {
    ...
    public static void main(String[] args) {
        ...
        if (args.length != 1) {
            ...
            queueName = "AsynchQueueExample_Test";
        } else {
         ...
         * listener displays the message obtained. Block until producer issues a control message
