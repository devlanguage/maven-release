...
public class ImqMessagePerformanceTest {
    ...
    static {
        try {
            ...
            IMQ_MESSAGE_SERVICE.setupConnections(config.get(ConfigurationConstant.MESSAGE_IMQHOME), config.get(ConfigurationConstant.MESSAGE_IMQPORT), config
                    .get(ConfigurationConstant.MESSAGE_USERNAME));
