...
import org.third.message.imq.util.bean.NbiBody;
...
import org.third.message.imq.util.helper.Configuration;
import org.third.message.imq.util.helper.ConfigurationConstant;
import org.third.message.imq.util.helper.ConfigurationLoader;
import org.third.message.imq.util.helper.ImqMessageService;
import org.third.message.imq.util.helper.ImqMessageUtil;
...
public class NbiMessageTest {
    ...
    static {
        try {
            config = ConfigurationLoader.load(ConfigurationConstant.CONFIG_FILE_NAME);
            IMQ_MESSAGE_SERVICE.setupConnections(config.get(ConfigurationConstant.MESSAGE_IMQHOME), config
                    .get(ConfigurationConstant.MESSAGE_IMQPORT), config.get(ConfigurationConstant.MESSAGE_USERNAME));
