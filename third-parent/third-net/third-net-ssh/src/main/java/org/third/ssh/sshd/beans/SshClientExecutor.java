...
//                KeyIdentityProvider defaultIdentities = sshClient.getKeyIdentityProvider();
                DefaultClientIdentitiesWatcher clientIdentitiesWatcher = new DefaultClientIdentitiesWatcher(
                        sshClient::getClientIdentityLoader, sshClient::getFilePasswordProvider, false);
                sshClient.setKeyIdentityProvider(clientIdentitiesWatcher);
    ...
    public SshExecuteRemoteCommandResult executeRemoteCommand(
        ...
        try {
            ...
            if (!isLogined) {
                errorMessage = "Failed to login before executeRemoteCommand. sshExecuteRemoteCommandRequest="
