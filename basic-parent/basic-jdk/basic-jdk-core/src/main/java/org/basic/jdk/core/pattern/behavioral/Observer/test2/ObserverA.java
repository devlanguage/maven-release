package org.basic.jdk.core.pattern.behavioral.Observer.test2;

/**
 * A concrete observer This concrete observer can change subject through call a concrete subject
 * setState function
 */
import java.io.*;
import java.util.*;
