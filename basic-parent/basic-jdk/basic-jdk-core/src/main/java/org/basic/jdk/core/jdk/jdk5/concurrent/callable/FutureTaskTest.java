package org.basic.jdk.core.jdk.jdk5.concurrent.callable;
...
public class FutureTaskTest {
    public static void main(String[] args) {
        ...
        java.util.concurrent.Callable pAccount = new PrivateAccount();
        java.util.concurrent.FutureTask futureTask = new FutureTask(pAccount);
        // 使用futureTask创建一个线程
