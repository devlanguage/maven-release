package org.basic.jdk.core.jdk.jdk7.e5_networking.ws.client;
...
import org.basic.jdk.core.jdk.jdk7.e5_networking.ws.HelloConstant;
import org.basic.jdk.core.jdk.jdk7.e5_networking.ws.client.doc_encoded_bare.HelloService;
import org.basic.jdk.core.jdk.jdk7.e5_networking.ws.client.handlers.HelloAuthHandlerClient;
...
public class HelloServiceTest extends TestCase {
    ...
    public void testAsyncCallWithResponse() {
        org.basic.jdk.core.jdk.jdk7.e5_networking.ws.client.async.HelloService helloService = new org.basic.jdk.core.jdk.jdk7.e5_networking.ws.client.async.HelloService(wsdl);
        setHandlerResolver(helloService);
        org.basic.jdk.core.jdk.jdk7.e5_networking.ws.client.async.HelloServicePort helloPort = helloService.getHelloServicePortPort();
        Response<org.basic.jdk.core.jdk.jdk7.e5_networking.ws.client.async.User> response = helloPort.sayHelloAsync(userName, age);
        try {
    ...
    public void testAsyncCallWithFuture() {
        class HelloAsyncHandler implements AsyncHandler<org.basic.jdk.core.jdk.jdk7.e5_networking.ws.client.async.User> {
            @Override
            public void handleResponse(Response<org.basic.jdk.core.jdk.jdk7.e5_networking.ws.client.async.User> res) {
    ...
    public void testHandlerWithAnnotation() {
        ...
        class HelloServiceClientImpl extends org.basic.jdk.core.jdk.jdk7.e5_networking.ws.client.rpc_encoded_wrapped.HelloService {
            public HelloServiceClientImpl(URL wsdl) {
                super(wsdl);
            }
        }
        HelloServiceClientImpl helloService = new HelloServiceClientImpl(wsdl);
        org.basic.jdk.core.jdk.jdk7.e5_networking.ws.client.rpc_encoded_wrapped.HelloServicePort helloPort = helloService
                .getHelloServicePortPort();
        logger.info("Client:" + helloPort.sayHello("test01", 22));
    }

    public void testHandlerWithResolve() {
        org.basic.jdk.core.jdk.jdk7.e5_networking.ws.client.rpc_encoded_wrapped.HelloService helloService = new org.basic.jdk.core.jdk.jdk7.e5_networking.ws.client.rpc_encoded_wrapped.HelloService(
                wsdl);
    ...
    public void testDocEncodedBare() {
      org.basic.jdk.core.jdk.jdk7.e5_networking.ws.client.doc_encoded_bare.HelloService helloService = new HelloService(wsdl);
      setHandlerResolver(helloService);
      org.basic.jdk.core.jdk.jdk7.e5_networking.ws.client.doc_encoded_bare.HelloServicePort helloPort = helloService
              .getHelloServicePortPort();
