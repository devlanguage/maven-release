...
public class CollectorsUnitTest {
    ...
    public void whenTeeing_ItShouldCombineTheResultsAsExpected() {
        ...
        Range range = numbers.stream().collect(teeing(minBy(Integer::compareTo), maxBy(Integer::compareTo),
    ...
    /**
     * Represents a closed range of numbers between {@link #min} and {@link #max},
     * both inclusive.
     */
