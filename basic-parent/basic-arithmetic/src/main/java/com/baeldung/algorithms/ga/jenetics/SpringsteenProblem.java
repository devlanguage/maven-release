...
public class SpringsteenProblem implements Problem<ISeq<SpringsteenRecord>, BitGene, Double> {
    ...
    public Function<ISeq<SpringsteenRecord>, Double> fitness() {
        return SpringsteenRecords -> {
            ...
            int uniqueSongCount = SpringsteenRecords.stream().flatMap(r -> r.songs.stream()).collect(Collectors.toSet())
                    .size();
    ...
    public static void main(String[] args) {
        ...
        SpringsteenProblem springsteen = new SpringsteenProblem(ISeq.of(
                ...
                new SpringsteenRecord("SpringsteenRecord6", 5, ISeq.of("Song18", "Song20", "Song30", "Song40"))),
        ...
        int uniqueSongCount = result.stream().flatMap(r -> r.songs.stream()).collect(Collectors.toSet()).size();
