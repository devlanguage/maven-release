...
public final class Data implements org.omg.CORBA.portable.IDLEntity
{
  ...
  public org.basic.net.c16_corba.oldImplBase.fallTIE.entity.Bounds viewExtent = null;
  public org.basic.net.c16_corba.oldImplBase.fallTIE.entity.IconSizes iconSize = null;

  //enum IconSize { Micro, Small, Medium, Large };
  public org.basic.net.c16_corba.oldImplBase.fallTIE.entity.IconFontSizes iconFontSize = null;
  ...
  public Data (int _viewId, double _overlap, String _name, boolean _filterLabels, boolean _systemView, boolean _overwrite, boolean _deleteThis, org.basic.net.c16_corba.oldImplBase.fallTIE.entity.Bounds _viewExtent, org.basic.net.c16_corba.oldImplBase.fallTIE.entity.IconSizes _iconSize, org.basic.net.c16_corba.oldImplBase.fallTIE.entity.IconFontSizes _iconFontSize, String[] _geoEntities)
  {
    viewId = _viewId;
    overlap = _overlap;
    name = _name;
