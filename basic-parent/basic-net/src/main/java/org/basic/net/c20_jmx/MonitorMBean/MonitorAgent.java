package org.basic.net.c20_jmx.MonitorMBean;
/*
...
public class MonitorAgent {
    ...
    private void depopulateTheAgent() {
        ...
        //
        int count = 0;
        for (Enumeration enum1 = simpleNameVector.elements(); enum1.hasMoreElements(); ) {
            ObjectName simpleName = (ObjectName)enum1.nextElement();
            try {
