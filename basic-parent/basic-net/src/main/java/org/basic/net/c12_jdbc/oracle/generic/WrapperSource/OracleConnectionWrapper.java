package org.basic.net.c12_jdbc.oracle.generic.WrapperSource;
...
/**
 * A simple implementation of a connection wrapper which may be nested to any
 * depth.
 */
...
public class OracleConnectionWrapper implements oracle.jdbc.OracleConnection {
    ...
    /**
     * Set a connection wrapper as the wrapper of this connection. Recursively
     * sets the wrapper to the lowest level. Thus the physical connection will
     * always know its outermost wrapper The recursion is terminated by the
     * method in oracle.jdbc.driver.OracleConnction which stores its argument.
     * 
     * @param wrapper
    ...
    public void openProxySession(int mode, java.util.Properties prop) throws SQLException {
    ...
    public void registerTAFCallback(oracle.jdbc.OracleOCIFailover cbk, Object obj) throws java.sql.SQLException {
    ...
    public void applyConnectionAttributes(java.util.Properties connAttr) throws SQLException {
    ...
    public java.util.Properties getUnMatchedConnectionAttributes() throws SQLException {
        return connection.getUnMatchedConnectionAttributes();
    }

    public void registerConnectionCacheCallback(oracle.jdbc.pool.OracleConnectionCacheCallback occc, Object userObj, int cbkFlag)
                    throws SQLException {
     ...
     *
     * @param typeName
     *            the name of the SQL type of the created object
     * @param elements
     ...
     * @since 11R1
     */
    public oracle.sql.ARRAY createARRAY(String typeName, Object elements) throws SQLException {
        return connection.createARRAY(typeName, elements);
    }

    /**
     * Creates an Array object with the given type name and elements. The
     * standard createArrayOf accepts the element type name. This method accepts
     * the type of the array itself. Oracle does not support anonymous array
     * types and so does not support the standard createArrayOf method.
     *
     * @param arrayTypeName
     *            the name of the SQL type of the created object
     * @param elements
     ...
     * @since 11.2.0.5.0
     */
    public java.sql.Array createOracleArray(String arrayTypeName, Object elements) throws SQLException {
        return connection.createARRAY(arrayTypeName, elements);
    }
    ...
    /**
     * Creates a DATE that has the given value. The value is interpreted as
     * being in the time zone represented by cal.
     *
     * @param value
     *            the value that the new object should repreesnt
     * @param cal
     ...
     * @since 11R1
     */
    public oracle.sql.DATE createDATE(java.sql.Date value, java.util.Calendar cal) throws SQLException {
     ...
     * @since 11R1
     */
    public oracle.sql.DATE createDATE(java.sql.Time value, java.util.Calendar cal) throws SQLException {
        return connection.createDATE(value, cal);
    }
     ...
     * @since 11R1
     */
    public oracle.sql.DATE createDATE(java.sql.Timestamp value, java.util.Calendar cal) throws SQLException {
        return connection.createDATE(value, cal);
    }
    ...
    /**
     * Creates a new TIMESTAMPTZ with the given value. The value is interpreted
     * in the time zone of the calendar.
     *
     * @param value
     *            the value that the new object should represent
     * @param cal
     ...
     * @since 11R1
     */
    public oracle.sql.TIMESTAMPTZ createTIMESTAMPTZ(java.sql.Date value, java.util.Calendar cal) throws SQLException {
     ...
     * @since 11R1
     */
    public oracle.sql.TIMESTAMPTZ createTIMESTAMPTZ(java.sql.Time value, java.util.Calendar cal) throws SQLException {
        return connection.createTIMESTAMPTZ(value, cal);
    }
     ...
     * @since 11R1
     */
    public oracle.sql.TIMESTAMPTZ createTIMESTAMPTZ(java.sql.Timestamp value, java.util.Calendar cal) throws SQLException {
        return connection.createTIMESTAMPTZ(value, cal);
    }
     ...
     * @since 11R1
     */
    public oracle.sql.TIMESTAMPTZ createTIMESTAMPTZ(String value, java.util.Calendar cal) throws SQLException {
        return connection.createTIMESTAMPTZ(value, cal);
    }
    ...
    /**
     * Creates a new TIMESTAMPLTZ with the given value. The value is interpreted
     * in the time zone of the calendar.
     *
     * @param value
     *            the value that the new object should represent
     ...
     * @since 11R1
     */
    public oracle.sql.TIMESTAMPLTZ createTIMESTAMPLTZ(java.sql.Date value, java.util.Calendar cal) throws SQLException {
     ...
     * @since 11R1
     */
    public oracle.sql.TIMESTAMPLTZ createTIMESTAMPLTZ(java.sql.Time value, java.util.Calendar cal) throws SQLException {
        return connection.createTIMESTAMPLTZ(value, cal);
    }
     ...
     * @since 11R1
     */
    public oracle.sql.TIMESTAMPLTZ createTIMESTAMPLTZ(java.sql.Timestamp value, java.util.Calendar cal) throws SQLException {
        return connection.createTIMESTAMPLTZ(value, cal);
    }
     ...
     * @since 11R1
     */
    public oracle.sql.TIMESTAMPLTZ createTIMESTAMPLTZ(String value, java.util.Calendar cal) throws SQLException {
        return connection.createTIMESTAMPLTZ(value, cal);
    }
     ...
     * @since 11R1
     */
    public oracle.sql.TIMESTAMPLTZ createTIMESTAMPLTZ(oracle.sql.DATE value, java.util.Calendar cal) throws SQLException {
        return connection.createTIMESTAMPLTZ(value, cal);
    }
    ...
    public java.sql.Struct createStruct(java.lang.String typeName, java.lang.Object[] attributes) throws SQLException {
     ...
     * @throws SQLException
     *             if the argument is not an interface
     * @since JDBC 4.0
     */
    public boolean isWrapperFor(Class<?> iface) throws SQLException {
        if (iface.isInterface())
            ...
            throw DatabaseError.createSqlException(oracle.jdbc.driver.DatabaseError.EOJ_DOES_NOT_WRAP_INTERFACE);
        }
    }
    ...
    protected class CloseInvocationHandler implements InvocationHandler {
        ...
        public Object invoke(Object proxy, Method method, Object[] args) throws Throwable {
            ...
            try {
                ...
                // the unwrap method is not intended to permit bypassing the
                // wrapper
                // it's purpose is to provide access to methods the wrapper
                // doesn't support
                // it's faster to just try than to do all the searching via
                // reflection
                return method.invoke(wrapper, args);
            } catch (IllegalArgumentException e) {
                // if the wrapper doesn't handle the method then let the wrapped
                // object
    ...
    protected <T> T proxyFor(Object obj, Class<T> iface) throws SQLException {
        // all this caching may not be strictly necessary if the VM does the
        // right thing,
        // but it demonstrates what is required for a correct implementation if
        // the VM
        // doesn't do it.
        try {
            ...
            if (proxy == null) {
                ...
                if (proxyClass == null) {
                    proxyClass = Proxy.getProxyClass(iface.getClassLoader(), new Class[] { iface });
                    proxyClasses.put(iface, proxyClass);
                }
                proxy = proxyClass.getConstructor(new Class[] { InvocationHandler.class }).newInstance(
                                new Object[] { new CloseInvocationHandler(this) });
                proxies.put(iface, proxy);
            }
            return (T) proxy;
        } catch (Exception e) {
            throw DatabaseError.createSqlException(oracle.jdbc.driver.DatabaseError.EOJ_ERROR, "Cannot construct proxy");
        }
    }
     ...
     * @throws SQLException
     *             if this does not implement the arg or the arg is not an
     *             interface
     * @since JDBC 4.0
     */
    ...
    public oracle.jdbc.dcn.DatabaseChangeRegistration registerDatabaseChangeNotification(java.util.Properties options) throws SQLException {
        return connection.registerDatabaseChangeNotification(options);
    }

    public oracle.jdbc.dcn.DatabaseChangeRegistration getDatabaseChangeRegistration(int regid) throws SQLException {
        return connection.getDatabaseChangeRegistration(regid);
    }

    public void unregisterDatabaseChangeNotification(oracle.jdbc.dcn.DatabaseChangeRegistration registration) throws SQLException {
    ...
    public void unregisterDatabaseChangeNotification(long registrationId, String callback) throws SQLException {
        connection.unregisterDatabaseChangeNotification((int) registrationId);
    }

    public oracle.jdbc.aq.AQNotificationRegistration[] registerAQNotification(String[] name, java.util.Properties[] options,
                    java.util.Properties globaloptions) throws SQLException {
    ...
    public oracle.jdbc.aq.AQMessage dequeue(String queueName, oracle.jdbc.aq.AQDequeueOptions opt, byte[] tdo) throws SQLException {
     ...
     */
    public oracle.jdbc.aq.AQMessage dequeue(String queueName, oracle.jdbc.aq.AQDequeueOptions opt, String typeName) throws SQLException {
     ...
     * 
     * @return TimeZone set through setDefaultTimeZone. Returns null if TimeZone
     *         if setDefaultTimeZone in not invoked with proper values.
     * @throws SQLException
