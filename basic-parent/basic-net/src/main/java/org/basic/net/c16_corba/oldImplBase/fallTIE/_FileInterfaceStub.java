...
public class _FileInterfaceStub extends org.omg.CORBA.portable.ObjectImpl implements org.basic.net.c16_corba.oldImplBase.fallTIE.FileInterface
{
  ...
  public org.basic.net.c16_corba.oldImplBase.fallTIE.FileInterfacePackage.Data[] downloadFile (String fileName)
  {
            ...
            try {
                ...
                $in = _invoke ($out);
                org.basic.net.c16_corba.oldImplBase.fallTIE.FileInterfacePackage.Data $result[] = org.basic.net.c16_corba.oldImplBase.fallTIE.FileInterfacePackage.DataListHelper.read ($in);
                return $result;
  ...
  public org.basic.net.c16_corba.oldImplBase.fallTIE.entity.Student sayHi (String user)
  {
            ...
            try {
                ...
                $in = _invoke ($out);
                org.basic.net.c16_corba.oldImplBase.fallTIE.entity.Student $result = org.basic.net.c16_corba.oldImplBase.fallTIE.entity.StudentHelper.read ($in);
                return $result;
            } catch (org.omg.CORBA.portable.ApplicationException $ex) {
                $in = $ex.getInputStream ();
                String _id = $ex.getId ();
