...
public class GzipTest {
	static final Logger logger = Logger.getLogger(GzipTest.class.getName());
	...
	public static byte[] compress(String str, String encoding) {
		...
		try {
			...
			logger.log(Level.SEVERE, "gzip compress error.", e);
		}
	...
	public static byte[] uncompress(byte[] bytes) {
		...
		try {
			...
			logger.log(Level.SEVERE,"gzip uncompress error.", e);
		}
	...
	public static String uncompressToString(byte[] bytes, String encoding) {
		...
		try {
			...
			logger.log(Level.SEVERE,"gzip uncompress to string error.", e);
		}
		return null;
	}
