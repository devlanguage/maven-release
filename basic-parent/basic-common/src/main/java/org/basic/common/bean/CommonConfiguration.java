...
public class CommonConfiguration extends Hashtable<String, String> {
    ...
    class PrefixStack {
        ...
        public String push(String item) {
            ...
            if (!SystemUtils.isNullOrBlank(prefix)) {
                prefix.append(".");
            }
...
//        updateNbiConfig(key, value);
    ...
    private void updateNbiConfig(String key, String value) {
        ...
        try {
            ...
            SystemUtils.closeQuitely(reader);
        }
        ...
        try {
            ...
            SystemUtils.closeQuitely(writer);
        }
    ...
    public String getValue(String name, String defaultValue) {
        ...
        return SystemUtils.isNullOrBlank(value) ? defaultValue : value;
    }
    ...
    private static boolean isCommentLine(String curStr) {
        ...
        if (SystemUtils.isNullOrBlank(curStr)) {
            return true;
        }
