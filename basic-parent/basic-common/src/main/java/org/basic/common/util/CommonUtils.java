...
public class CommonUtils {
	public static final String IDM_CONF_HOME = System.getProperty("IDM_CONF_HOME") == null
	...
	public static final String ENDPOINT_AUTOPASS = "https" + "://" + ENV_AUTOPASS_SERVER_HOST; // +
																								// EnvUtils.getAutopassserverport();
	public static final String ENDPOINT_API_REGISTRY = "https" + "://" + ENV_API_REGISTRY_HOST + ":"
			+ ENV_API_REGISTRY_PORT;
	...
	/**
	 * Search for one {@code File} based on {@code String} argument file. Search
	 * rule are as below
	 * <p>
	 * 1) if file starts with "classpath:", it will search from the current
	 * classloader resource directory. if found, return. otherwise
	 * <p>
	 * 2) if file starts with "WEB-INF", it will search from the current
	 * web-application. if found, return. otherwise
	 * <p>
	 * 3) it searches file from absolute path. if found, return. otherwise
	 * <p>
	 * 4) it searches file from the path specified by system environment
	 * "IDM_CONF_HOME"
	 * 
	...
	/**
	 * Parse the toString of one object as boolean. if toString of object argument
	 * is "true" or "enabled", ignoring case, it return {@code true}
	 * 
