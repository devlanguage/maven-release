...
public class NumberUtils {
	 ...
	 * the specified value with a <code>RoundingMode</code> applied. If the input
	 * <code>value</code> is <code>null</code>, we simply return
	 ...
	 * try successively larger types from <code>Integer</code> to
	 ...
	 * (0xhhhh) and octal (0dddd) notations. N.B. a leading zero means octal; spaces
	 * are not trimmed.
	 * </p>
	 *
	 * <p>
	...
	/**
	 * <p>
	 * Convert a <code>String</code> to a <code>Long</code>; since 3.1 it handles
	 * hex (0Xhhhh) and octal (0ddd) notations. N.B. a leading zero means octal;
	...
	public static boolean isCreatable(final String str) {
		...
		if (sz > start + 1 && chars[start] == '0' && !str.contains(".")) { // leading 0, skip if is a
																						// decimal number
	...
	public final static boolean isComposedByDigit(String digit) {
		...
		return SystemUtils.isNullOrBlank(digit) ? false : digit.matches("[0-9]*");
	}
}
