...
/**
 * This class extends the <code>java.awt.Panel</code> class to form a panel
 * which holds the buttons/choices/labels that control the animation of the
 * algorithm.
 * 
 * @see Panel
 */
public class ControlPanel extends Panel {
     ...
     * 
     * @param frame
     *            The parent window frame that contains this panel
     * @param algname
     *            The algorithm name parsed from the applet parameter
     */
    ...
    /**
     * @return Step button to trace through the execution of the algorithm. If
     *         the <code>Run</code> button has already been pressed, the
