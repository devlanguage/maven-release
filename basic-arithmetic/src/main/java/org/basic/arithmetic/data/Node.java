...
/**
 * This class holds the information regarding a node from the heap/complete binary tree. This class implements the
 * <code>DrawingObj</code> interface and hence can be freely added to the drawing panel using the
 * <code>addDrawingObj</code> method. e.g. <code><pre>
 * 	Node node = new Node();
 * 	drawingPanel.addDrawingObj(node);
 * </pre></code> Any added drawing object can be remove from the panel by using the <code>removeObj</code> method. e.g.
 * <code><pre>
...
public class Node implements DrawingObj {
    ...
    /**
     * Create a node with the left and right child nodes specified and the weight of the current node is the sum of the
     * child node.
     * 
     * @param node1
     *            The left node of this newly created node.
     * @param node2
     *            The right node of this newly created node.
     */
     ...
     * 
     * @param node
     *            The left node of the newly created node.
     */
     ...
     * 
     * @param weight
     *            The weight to be assigned to this node.
     */
     ...
     * 
     * @param label
     *            The label to be assigned to this node.
     */
     ...
     * 
     * @param x
     *            The horizontal destination position of this node.
     * @param y
     *            The vertical destination position of this node.
     */
     ...
     * 
     * @param node
     *            The root node of the tree to be moved.
     * @param dx
    ...
    public void draw(Graphics g) {
        ...
        if (getLeftNode() != null) {
            g.setColor(Color.black);
            g.drawLine(x + 6, y + 30, getLeftNode().x + 10, getLeftNode().y);
            if (highlightLeft) {
                g.setColor(Color.blue);
                g.drawLine(x + 5, y + 30, getLeftNode().x + 9, getLeftNode().y);
                g.drawLine(x + 4, y + 30, getLeftNode().x + 8, getLeftNode().y);
            }
        }

        if (getRightNode() != null) {
            g.setColor(Color.black);
            g.drawLine(x + 14, y + 30, getRightNode().x + 10, getRightNode().y);
            if (highlightRight) {
                g.setColor(Color.blue);
                g.drawLine(x + 15, y + 30, getRightNode().x + 11, getRightNode().y);
                g.drawLine(x + 16, y + 30, getRightNode().x + 12, getRightNode().y);
            }
        }
    }
} // class Node
