...
public class CodeConvertionUtil {
	...
	/**
	 * Chunk separator, we use a newline to separate chunks of encoded data (if you
	 * ask for it to be chunked)
	 */
	...
	/**
	 * Encodes binary data using the base64 algorithm (this does not "chunk" the
	 * output).
	 * 
	...
	/**
	 * This array tests a given byte array to see if it contains only valid
