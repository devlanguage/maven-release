...
public class BasicRuntimeException extends RuntimeException {
    ...
    public BasicRuntimeException(String errorMsg) {
        super(errorMsg);
    }

    public BasicRuntimeException(BasicExceptionType exType, BasicExceptionSubType exSubType) {
        super(exSubType.getErrorMsg());
        this.type = exType;
        this.subtype = exSubType;
    }

    public BasicRuntimeException(BasicExceptionType exType, BasicExceptionSubType exSubType, String errorMsg) {
        super(errorMsg);
        this.type = exType;
        this.subtype = exSubType;
    }

    public BasicRuntimeException(BasicExceptionType exType, Exception ex) {
        super(ex.getMessage());
        this.type = exType;
        super.fillInStackTrace();
    }

    public BasicRuntimeException(BasicExceptionType exType, BasicExceptionSubType exSubType, Exception ex) {
        super(ex.getMessage());
        this.type = exType;
        this.subtype = exSubType;
        super.fillInStackTrace();
    ...
    public BasicRuntimeException(BasicExceptionType exType, String detailErrorInfo) {
        super(detailErrorInfo);
        this.type = exType;

    }

    public BasicRuntimeException(Exception ex) {
        super(ex.getMessage());
        super.fillInStackTrace();
    }

    public BasicRuntimeException(String msg, Throwable t) {
        super(msg, t);
    }

    public BasicRuntimeException(BasicExceptionType exType, String msg, Throwable t) {
        super(msg, t);
        this.type = exType;
    }

    public BasicRuntimeException(BasicExceptionType exType, BasicExceptionSubType exSubType, String msg, Throwable t) {
        super(msg, t);
        this.type = exType;
        this.subtype = exSubType;
    }
